...
// import Logo from "@/assets/logo.svg"; // Removed old logo import
    ...
    >
      <nav className="grid grid-cols-2 p-4 container mx-auto">
        <Link href="/" className="flex items-center gap-1">
          <Image
            src="https://i.ibb.co/WN7mYdLt/logo.png"
            className="w-9 mr-1"
            alt="MindSite Logo"
            width={64}
            height={64}
          />
          <p className="font-sans text-white text-xl font-bold">MindSite</p>
        </Link>
