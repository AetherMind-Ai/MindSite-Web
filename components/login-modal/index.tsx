...
export const LoginModal = ({
  ...
  html,
  onClose,
  title = "Log In to use MindSite for free",
  description = "Log In through your Hugging Face account to continue using MindSite and increase your monthly free limit.",
}: {
  open: boolean;
  html?: string;
